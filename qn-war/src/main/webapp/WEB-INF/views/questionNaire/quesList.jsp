    ...
    <script type="text/javascript">
        ...
        function delQues(seq) {
            if (confirm("您确实要删除该问题吗？删除后，不能再恢复。")) {
                window.self.location = "./delQues.jsp?oid="+<%=oid%>+
                "&seq=" + seq;
            }
        }
...
<tr>
    <td height="10">
        <span> <input type="button" name="sbmQues" onclick="newQues();" value=" 新建题目 "/> </span>
    </td>
</tr>
<tr>
    <td colspan="5">
                        ...
                        <table class="table2">
                            ...
                            <tr>
                                <td width="25%" valign="top">
                                    <input type="radio" id="<%=radioName%>"
                                           name="<%=radioName%>" value="<%=sel.getSelseq()%>"/><%=sel.getContent()%>
                                </td>
                                <%
                                    if (j == 3) {
                                %>
