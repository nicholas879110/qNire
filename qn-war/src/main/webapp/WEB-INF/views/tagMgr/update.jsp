...
<div class="row">
    ...
    <div class="col-xs-12">
        <!-- PAGE CONTENT BEGINS -->
        <form action="/tagMgr/update.action" class="form-horizontal form-border" method="post" id="updateFrom">


            <input type="text" hidden="true" name="id" value="${tag.id}"/>
...
<script type="text/javascript">
    $(function(){
        $("#update-btn").click(function(){
            ...
            $.ajax({
                url: getContentPath()+"/tagMgr/update.do",
