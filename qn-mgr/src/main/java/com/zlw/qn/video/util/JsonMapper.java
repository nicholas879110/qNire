package com.zlw.qn.video.util;

import com.zlw.qn.commons.date.DateFormatEnum;
 ...
 * File name: JsonMapper <br>
 * Create DateTime: 15-2-12 下午3:44 <br>
 * Version: 1.0 <br>
 * Author: zlw
 */
public class JsonMapper {
    ...
    public static String toLogJson(Object object) {
        ...
        jsonMapper.setDateFormat(DateFormatEnum.YYYY_MM_DD_HH_MM_SS.getValue());
